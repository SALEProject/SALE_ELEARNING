...
/**
 * Strings for component 'enrol_flatfile', language 'ro', branch 'MOODLE_25_STABLE'
 *
...
$string['encoding'] = 'Codarea fișierului';
...
$string['flatfile:manage'] = 'Administrați în mod manual înrolarea utilizatorilor';
$string['location'] = 'Locaţie fişier';
$string['notifyadmin'] = 'Notificați administratorul';
$string['notifyenrolled'] = 'Notificați utilizatorii înrolați';
$string['pluginname'] = 'Fișier flat (CSV)';
