...
/**
 * Strings for component 'qtype_shortanswer', language 'ro', branch 'MOODLE_25_STABLE'
 *
...
$string['pluginname_help'] = 'Ca răspuns la o întrebare (care poate să includă o imagine) respondentul tastează  un cuvânt sau o frază scurtă. Ar putea fi mai multe răspunsuri corecte posibile, fiecare de o notă diferită. Dacă este selectată opțiunea "Case sensitive", atunci puteți avea scoruri diferite pentru "Cuvânt" sau "cuvânt"';
